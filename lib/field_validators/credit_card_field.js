...
*/
var CreditCardField = function (options) {
    this._isSubTypeOf = new BaseField(options);
    this._isRequired = options && options.required;
    this._cardValidationOptions = options && options.cardValidationOptions;
}

CreditCardField.prototype.type = 'CreditCardField';
...
CreditCardField.prototype.validate = function (inp) {
...
CreditCardField.prototype.getMetaData = function (inp) {
    return _validateCreditCard(inp);
}

CreditCardField.prototype.toFormattedString = function (inp) {
    if (inp) {
...
CreditCardField.prototype.fromString = function (inp) {
