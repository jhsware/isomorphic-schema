...
*/
var IOrgNrField = require('../interfaces').IOrgNrField;

var OrgNrField = createObjectPrototype({
    ...
    validate: function (inp) {
        ...
        if (inp) {
            ...
            try {
                ...
                var i18nLabel = i18n('isomorphic-schema--org_nr_field_incorrect_formatting', 'Malformatted'),
