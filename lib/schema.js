...
Schema.prototype._addFieldError = function (formErrors, propName, error) {
    if (typeof formErrors.field_errors === "undefined") {
        formErrors.field_errors = {};
    }
    formErrors.field_errors[propName] = error;
};

Schema.prototype._addInvariantError = function (formErrors, error) {
    if (typeof formErrors.invariant_errors === "undefined") {
        formErrors.invariant_errors = [];
    }
    formErrors.invariant_errors.push(error);
};
...
Schema.prototype.validate = function (data, options) {    
    ...
    if (typeof formErrors.field_errors === "undefined" && typeof formErrors.invariant_errors === "undefined") {
        return undefined;
    } else {
        return formErrors;
    }
