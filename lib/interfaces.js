...
module.exports.IDynamicSelectBaseField = createInterface({
    name: 'IDynamicSelectBaseField'
});

module.exports.IDynamicSelectAsyncBaseField = createInterface({
...
module.exports.IDynamicMultiSelectField = createInterface({
...
module.exports.IAnyOf =  createInterface({
    name: 'IAnyOf'
});